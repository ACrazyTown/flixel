...
class FlxShader implements IFlxDestroyable
{
    ...
    {
        // var legacyShader = new FlxShader({
        //     flash: {
        ...
        //         vertex: 
        //         {
        //             source: "some glsl code",
        //             attributes: ["aPosition", "aTexCoord", "aColorMultiplier", "aColorOffset"],
        //             precision: MEDIUM
        //         },
        //         fragment: 
        //         {
        ...
        // var shader = new FlxShader({
        //     gl: {
        //         vertexPrecision: HIGH,
        //         vertexSource: "some glsl",
        //         vertexAttributes: ["aPosition", "aTexCoord", "aColorMultiplier", "aColorOffset", "aTexSlot"],

        //         fragmentPrecision: MEDIUM,
        //         fragmentSource: "some glsl"
        //     }
        // });
        ...
        for (i in 0...numUniforms)
        {
            ...
            var uniform:FlxShaderUniform = 
            {
                ...
                value: switch (info.type) 
                {
                    ...
                    // GLSL booleans can be represented with an int
                    // same goes for samplers
                    case GL.INT, GL.BOOL, GL.SAMPLER_2D: INT1(0);
                    case GL.INT_VEC2, GL.BOOL_VEC2: INT2(0, 0);
                    case GL.INT_VEC3, GL.BOOL_VEC3: INT3(0, 0, 0);
                    case GL.INT_VEC4, GL.BOOL_VEC4: INT4(0, 0, 0, 0);

                    case GL.FLOAT_MAT4: null;

                    default: throw 'Unsupported ${info.name}';
                }
            };
